...
class WriteAnswer extends StatefulWidget {
  ...
  WriteAnswer({this.userId,this.docId,this.docId2});
  @override
  _WriteAnswerState createState() => _WriteAnswerState(userId,docId,docId2);
}
class _WriteAnswerState extends State<WriteAnswer> {
  String docId,userId,answer,question,docId2;
  FirebaseFirestore _firestore=FirebaseFirestore.instance;
  _WriteAnswerState(String userId, String docId,String docId2){
    this.docId=docId;
    this.userId=userId;
    this.docId2=docId2;
    print(docId);
